...
## Objective
This repository contains an example of MCC generated code using Foundation Services library for SPI as described in [*TB3265 - Getting Started with SPI using MSSP on PIC18*](http://ww1.microchip.com/downloads/en/DeviceDoc/Getting-Started-With-SPI-Using-MSSP-on-PIC18-DS90003265A.pdf) document from Microchip.
...
2. Open the *pic18f47q10-cnano-spi-host-send-fs.X* project in MPLAB® X IDE.

3. Set *pic18f47q10-cnano-spi-host-send-fs.X* project as main project. Right click on the project in the *Projects* tab and click *Set as Main Project*.

4. Select the *PIC18F47Q10 Curiosity Nano* in the *Hardware Tool* section of the project settings:
  - Right click on the project and click *Properties*;
  - Select the *PIC18F47Q10 Curiosity Nano* (click on the SN) in the *Hardware Tool* tab and then click *OK*:
<br><img src="images/SPI-host-send-fs-tool.PNG" width="600">
